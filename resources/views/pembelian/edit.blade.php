...
<div class="container mt-4" style="width: 80%;">
    ...
    <form action="{{ url('pembelian/'.$data->kode) }}" method='post' autocomplete="off">
        @csrf
        @method('PUT')
        <div class="my-6 p-3 px-5 bg-body rounded shadow-sm">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='pabrikan' value="{{ $data->pabrikan }}" id="pabrikan">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='mobil' value="{{ $data->mobil }}" id="mobil">
                </div>
            </div>
