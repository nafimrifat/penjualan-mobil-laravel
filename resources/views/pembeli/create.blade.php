...
<div class="container mt-4" style="width: 80%;">
    ...
    <form action="{{ url('pembeli') }}" method='post' autocomplete="off">
        @csrf
        <div class="my-6 p-3 px-5 bg-body rounded shadow-sm">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='jns_kel' value="{{ Session::get('jns_kel') }}" id="jns_kel">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='usia' value="{{ Session::get('usia') }}" id="usia">
                </div>
            </div>
